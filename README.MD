...
Como estudante de back-end Java, eu tenho como objetivo fazer não apenas uma API simples, mas tentar deixa-la o mais estrutural possível e de forma profissional. 
...
8. [x] DTOs.
9. [x] Logs.
10. [x] Testes Unitários (JUnint5 e Mock).
